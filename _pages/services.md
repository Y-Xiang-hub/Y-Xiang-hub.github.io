...
<div style="margin: 3px 0; padding: 3px;">
  <ul style="margin: 0; padding-left: 20px; font-size: 0.95em; color: #555; line-height: 1.6;">
    ...
    <li>
      <div style="margin: 3px 0; padding: 3px;">
        <strong>Reviewer/Sub-reviewer:</strong> NDSS'26, KDD'25 (top-10% outstanding reviewer), DSN'25, WWW'25, IJCNN'25, ICLR'25 Workshop Advances in Financial AI, CHI'25 Case Studies
      </div>
    </li>
  </ul>
</div>
